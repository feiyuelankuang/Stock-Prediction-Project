...
def train_kg(root,model,combine,stock=None):
    ### Parse arguments here ###
...
if __name__ == '__main__':
    ...
    parser.add_argument("--stock",type=int, default= 0,help="root path")
    args = parser.parse_args()
    for i in range(5):
        train(stock=args.stock)
        train_kg(root=args.root,model=args.model,combine=args.combine,stock=args.stock)
        #train()
